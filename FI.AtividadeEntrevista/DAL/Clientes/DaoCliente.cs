...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal long Incluir(DML.Cliente cliente)
        {
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("CPF", ConverterCpf.ToLong(cliente.CPF)));
        ...
        internal bool VerificarExistencia(string CPF)
        {
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("CPF", ConverterCpf.ToLong(CPF)));
        ...
        internal bool VerificarExistenciaCPFOutroCliente(string CPF, long Id)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
            ...
            DataSet ds = base.Consultar("FI_SP_VerificaCPFCliente", parametros);
        ...
        private List<DML.Cliente> Converter(DataSet ds)
        {
            ...
            if (ds != null && ds.Tables != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                foreach (DataRow row in ds.Tables[0].Rows)
                {
                    ...
                    cli.CPF = ConverterCpf.ToLong(row.Field<string>("CPF")).ToString();
